...
export const AGENT_SIGNALS = [
  { registrar_id: "cloudflare-registrar", api_available: true, scoped_tokens: true, oauth_support: false, dns_api: true, webhooks: false, audit_logs: true, human_approval_flow: false, sandbox: false, openapi_spec: true, last_checked: "2026-05-30T04:12:00Z", verification_status: "public_sources" as VerificationStatus },
  { registrar_id: "namecheap", api_available: true, scoped_tokens: false, oauth_support: false, dns_api: true, webhooks: false, audit_logs: false, human_approval_flow: false, sandbox: true, openapi_spec: false, last_checked: "2026-05-30T04:12:00Z", verification_status: "registrar_submitted" as VerificationStatus },
  { registrar_id: "porkbun", api_available: true, scoped_tokens: false, oauth_support: false, dns_api: true, webhooks: false, audit_logs: false, human_approval_flow: false, sandbox: false, openapi_spec: false, last_checked: "2026-05-30T04:12:00Z", verification_status: "registrar_submitted" as VerificationStatus },
];
